...
public class Csv {
    ...
    public static class Reader {
        ...
        private String unescape(String s) {
            ...
            if (result.contains("\""))
                throw new FormatException("invalid csv: misplaced quote"); // could this ever happen at all?
            result = unmarkDoubleQuotes(result);
            return result;
        }

        private String unmarkDoubleQuotes(String s) {
            return s.replace(impossibleString, "\"");
        }

        private String markDoubleQuotes(String s) {
            return s.replace("\"\"", impossibleString);
        }
        ...
        public Reader delimiter(char delimiter) {
            this.delimiter = delimiter;
            return this;
        }

        public Reader preserveSpaces(boolean preserveSpaces) {
            this.preserveSpaces = preserveSpaces;
            return this;
        }

        public Reader ignoreEmptyLines(boolean ignoreEmptyLines) {
            this.ignoreEmptyLines = ignoreEmptyLines;
            return this;
        }

        public Reader ignoreComments(boolean ignoreComments) {
